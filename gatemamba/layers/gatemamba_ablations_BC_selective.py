...
class GateMambaGCN_ablations_BC_selective(pyg_nn.conv.MessagePassing):
    def __init__(
        self, 
        d_model,
        conv_layes, 
        ...
        self.x_proj = nn.Linear(self.d_inner, self.d_state * 2, bias=False, **factory_kwargs)     # selective projection used to make dt, B and C input dependant
