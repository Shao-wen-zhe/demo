...
class GateMambaGCN_ablations_DeltaC_selective(pyg_nn.conv.MessagePassing):
    def __init__(
        self, 
        d_model,
        conv_layes, 
        ...
        self.Wc = nn.Linear(self.d_model, self.d_state, bias=bias, **factory_kwargs)
        self.W1 = nn.Linear(self.d_inner, self.dt_rank, bias=bias, **factory_kwargs)
    ...
    def forward(self, x, edge_index, A_norm, edge_attr):
        ...
        delta = self.dt_proj.weight @ self.W1(h).t()
